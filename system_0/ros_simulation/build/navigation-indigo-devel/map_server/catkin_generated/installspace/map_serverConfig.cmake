...
if("FALSE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /home/ivan/antlab-repo/system_0/ros_simulation/src/navigation-indigo-devel/map_server)
  set(map_server_DEVEL_PREFIX /home/ivan/antlab-repo/system_0/ros_simulation/devel)
  ...
  set(map_server_INSTALL_PREFIX /home/ivan/antlab-repo/system_0/ros_simulation/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ivan/antlab-repo/system_0/ros_simulation/install/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
    _list_append_unique(map_server_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_loader")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${map_server_dep}_FOUND)
      find_package(${map_server_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${map_server_dep} REQUIRED ${depend_list})
  endif()
