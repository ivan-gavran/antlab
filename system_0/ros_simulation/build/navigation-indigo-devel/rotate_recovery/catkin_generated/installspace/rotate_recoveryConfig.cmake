...
if("FALSE" STREQUAL "TRUE")
  set(rotate_recovery_SOURCE_PREFIX /home/ivan/antlab-repo/system_0/ros_simulation/src/navigation-indigo-devel/rotate_recovery)
  set(rotate_recovery_DEVEL_PREFIX /home/ivan/antlab-repo/system_0/ros_simulation/devel)
  ...
  set(rotate_recovery_INSTALL_PREFIX /home/ivan/antlab-repo/system_0/ros_simulation/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'rotate_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ivan/antlab-repo/system_0/ros_simulation/install/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rotate_recovery_dep}_FOUND)
      find_package(${rotate_recovery_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rotate_recovery_dep} REQUIRED ${depend_list})
  endif()
