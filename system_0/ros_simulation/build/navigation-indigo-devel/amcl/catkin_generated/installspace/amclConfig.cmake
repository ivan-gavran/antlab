...
if("FALSE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/ivan/antlab-repo/system_0/ros_simulation/src/navigation-indigo-devel/amcl)
  set(amcl_DEVEL_PREFIX /home/ivan/antlab-repo/system_0/ros_simulation/devel)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /home/ivan/antlab-repo/system_0/ros_simulation/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/ivan/antlab-repo/system_0/ros_simulation/install/${idir}'.  Ask the maintainer 'David V. Lu!! <davidvlu@gmail.com>, Michael Ferguson <mferguson@fetchrobotics.com>' to fix it.")
    endif()
...
set(depends "rosbag;roscpp;dynamic_reconfigure;tf")
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${amcl_dep}_FOUND)
      find_package(${amcl_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${amcl_dep} REQUIRED ${depend_list})
  endif()
