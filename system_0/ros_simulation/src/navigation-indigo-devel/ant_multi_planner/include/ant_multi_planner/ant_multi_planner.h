#ifndef ANT_MULTI_PLANNER__ANT_MULTI_PLANNER_H_
#define ANT_MULTI_PLANNER__ANT_MULTI_PLANNER_H_
...
{
	class AntMultiPlanner : public multi_planner_base::MultiPlanner
	{
	public:
