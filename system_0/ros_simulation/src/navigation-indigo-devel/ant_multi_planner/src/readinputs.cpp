...
void readPrimitives(prim_vec_t &primitives, string filename)
{
  ifstream ifp;
...
void readPositionsWithCost ( std::vector<position_with_cost> &positions, string filename )
{
  ifstream ifp;
  string line;
