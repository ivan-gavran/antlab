...
#     
    def __init__(self, availableRobots=['robot_0', 'robot_1', 'robot_2'], listOfPositions={'robot_0':[(1,2), (0,0)], 'robot_1':[ (0,-0.5), (1,1)],\
                                                                                'robot_2':[ (2,-1), (1.5,1)]}):
        rospy.loginfo('coordinator initialization')
        self.nextPositionIndex = {'robot_0':0, 'robot_1':0, 'robot_2':0}
    ...
    def askForNextLocation(self, msg=String("")):
        ...
        if msg.data == "failure":
            rospy.logerr(robotName+" failure by patrolling")
        rospy.logwarn(robotName)
...
def main():
    ...
    coordinator = PatrolCoordinator(availableRobots=['robot_0', 'robot_1', 'robot_2'])
